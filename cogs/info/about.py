...
class About(commands.Cog):
    ...
    async def about(
        ...
        embed.add_field(
            name = "📀・О проекте:",
            value = "DrewBot создается усилиями многих авторов и обычных людей, которые привносят свой вклад в проект! Вы тоже можете помочь нам в его развитии, подробнее на [странице репозитория проекта](https://github.com/nassendg/drew3).",
            inline = False
        )
        embed.add_field(
